...
Context::getContext()->controller->addJS(vc_asset_url('lib/progress-circle/ProgressCircle.js'));
Context::getContext()->controller->addJS(vc_asset_url('lib/vc_chart/jquery.vc_chart.js'));
