...
$results = JsComposer::get_uploaded_files_result($perPage, $startFrom);
        ...
        <?php } ?>
                    ...
                    <ul class="grid cs-style-2 <?php echo "list-view" . Tools::safeOutput($view); ?>">
                        ...
                        if (!empty($results)){
                            ...
                            echo $pagingHTML;
                            echo JsComposer::get_uploaded_files_markup($results);  
                            echo $pagingHTML;
                        }
                        ?>
...
<?php $timestamp = time(); ?>
        ...
        $(function() {
            ...
            $('#txtImageInsert').click(function() {
                ...
                var iframe_img = [id, '<?php echo $url ?>' + filename];
