...
if ( ! function_exists( 'vc_load_default_templates' ) ) {
	/**
	 * load default templates list
	 *
	 * @param none
	 * @since 4.3 prestashop
	 * @return array
	 */
	function vc_load_default_templates( ) {
...
function vc_map_get_attributes( $tag, $atts = array() ) {
	return JsComposer::shortcode_atts( vc_map_get_defaults( $tag ), $atts, $tag );
}