...
//		return json_decode( file_get_contents(Tools::getHttpHost(true).vc_asset_url( 'js/params/google_fonts.json' ) ) );
            if(file_exists(vc_manager()->composer_settings['ASSETS_DIR'] . '/js/params/google_fonts.json')){
		return json_decode( file_get_contents(vc_manager()->composer_settings['ASSETS_DIR'] . '/js/params/google_fonts.json'  ) );
            }
            return null;
	}
