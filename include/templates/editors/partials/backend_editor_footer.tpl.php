...
$add_element_box->render($editor);

// Edit form for mapped shortcode.
visual_composer()->editForm()->render();

visual_composer()->templatesEditor()->render($editor);
...
<?php 
//return ;// error after it.. need to add shortcodes..
