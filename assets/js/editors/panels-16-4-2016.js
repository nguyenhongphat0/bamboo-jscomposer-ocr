...
(function($) {
  ...
  vc.updateSettingsBadge = function() {
    ...
    if(window.help_class_name === 'VC_frontend')
      ...
      value = $('.'+customCSSElem+'[data-id_lang="'+window.sds_id_lang()+'"]').val();
    }
...
//      console.log(this.model.attributes.params);
...
//      this.saved_css_data = (window.help_class_name === 'VC_frontend') ? vc.$custom_css.eq(0).val() : vc.$custom_css.eq(window.sds_id_lang() - 1).val();      
      this.saved_css_data = (window.help_class_name === 'VC_frontend') ? vc.$custom_css.eq(0).val() : vc.$custom_css.filter('[data-id_lang="'+window.sds_id_lang()+'"]').val();      
    ...
    setEditor: function() {
        ...
        if(window.help_class_name === 'VC_frontend')
            ...
            value = vc.$custom_css.filter('[data-id_lang="'+window.sds_id_lang()+'"]').val();
//            value = vc.$custom_css.eq(window.sds_id_lang() - 1).val();
