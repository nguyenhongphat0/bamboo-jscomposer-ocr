...
(function ($) {
    ...
    window.VcTabsView = vc.shortcode_view.extend({
        ...
        createAddTabButton:function () {
            ...
            this.$add_button = $('<li class="add_tab_block"><a href="#new-tab-' + new_tab_button_id + '" class="add_tab" title="' + window.i18nLocale.add_tab + '"><i class="icon-plus"></i></a></li>').appendTo(this.$tabs.find(".tabs_controls"));
        },
        addTab:function (e) {
            e.preventDefault();
