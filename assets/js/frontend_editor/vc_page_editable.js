...
(function($) {
 ...
 /* .mouseup(function(){
  ...
  vc_iframe.loadImageGalleryJs = function(jstype) {
    if (document.contains(document.getElementById("jsIdImageGallery")))
      document.getElementById("jsIdImageGallery").remove();
      
    var div_element = document.createElement('div');
    div_element.id = 'jsIdImageGallery';
    document.getElementById("content-wrapper").appendChild(div_element);

    if(jstype == 'flexslider_fade'){
      var link = document.createElement( "link" );
      link.href = "modules/jscomposer/assets/lib/flexslider/flexslider.css";
      link.type = "text/css";
      link.rel = "stylesheet";
      link.media = "screen,print";
      document.getElementById("jsIdImageGallery").appendChild(link);

      var script   = document.createElement("script");
      script.type  = "text/javascript";
      script.src   = 'modules/jscomposer/assets/lib/flexslider/jquery.flexslider-min.js';
      document.getElementById("jsIdImageGallery").appendChild(script);
    } else if(jstype == 'flexslider_slide'){
      var link = document.createElement( "link" );
      link.href = "modules/jscomposer/assets/lib/flexslider/flexslider.css";
      link.type = "text/css";
      link.rel = "stylesheet";
      ...
      var script   = document.createElement("script");
      script.type  = "text/javascript";
      script.src   = 'modules/jscomposer/assets/lib/nivoslider/jquery.nivo.slider.pack.js';
      document.getElementById("jsIdImageGallery").appendChild(script);

      var link = document.createElement( "link" );
      link.href = "modules/jscomposer/assets/lib/nivoslider/nivo-slider.css";
      link.type = "text/css";
      link.rel = "stylesheet";
      link.media = "screen,print";
      document.getElementById("jsIdImageGallery").appendChild(link);
      ...
      var link = document.createElement( "link" );
      link.href = "modules/jscomposer/assets/lib/nivoslider/themes/default/default.css";
      link.type = "text/css";
      link.rel = "stylesheet";
      link.media = "screen,print";
      document.getElementById("jsIdImageGallery").appendChild(link);
    } else if(jstype == 'image_grid'){
      var script   = document.createElement("script");
      script.type  = "text/javascript";
      script.src   = 'modules/jscomposer/assets/lib/isotope/dist/isotope.pkgd.min.js';
      document.getElementById("jsIdImageGallery").appendChild(script);
    }
  };
  vc_iframe.loadCarousel = function() {
    if (document.contains(document.getElementById("jsIdCarousel")))
      document.getElementById("jsIdCarousel").remove();
      
    var div_element = document.createElement('div');
    div_element.id = 'jsIdCarousel';
    document.getElementById("content-wrapper").appendChild(div_element);


    var link = document.createElement( "link" );
    link.href = "modules/jscomposer/assets/lib/vc_carousel/css/vc_carousel.css";
    link.type = "text/css";
    link.rel = "stylesheet";
    link.media = "screen,print";
    document.getElementById("jsIdCarousel").appendChild(link);

    var link = document.createElement( "link" );
    link.href = "modules/jscomposer/assets/lib/prettyphoto/css/prettyPhoto.css";
    link.type = "text/css";
    link.rel = "stylesheet";
    link.media = "screen,print";
    document.getElementById("jsIdCarousel").appendChild(link);
    ...
    var script   = document.createElement("script");
    script.type  = "text/javascript";
    script.src   = 'modules/jscomposer/assets/lib/vc_carousel/js/transition.js';
    document.getElementById("jsIdCarousel").appendChild(script);

    var script   = document.createElement("script");
    script.type  = "text/javascript";
    script.src   = 'modules/jscomposer/assets/lib/vc_carousel/js/vc_carousel.js';
    document.getElementById("jsIdCarousel").appendChild(script);

    var script   = document.createElement("script");
    script.type  = "text/javascript";
    script.src   = 'modules/jscomposer/assets/lib/prettyphoto/js/jquery.prettyPhoto.js';
    document.getElementById("jsIdCarousel").appendChild(script);
...
//     if($tab.hasClass('ui-widget')) $call.tabs('destroy');
