...
//                var_dump(__LINE__);
	...
	public function save() {
		...
		$template_arr = array( "name" => stripslashes( $template_name ), "template" =>  $template );
...
//		$saved_templates = get_option( $this->option_name );
	...
	public function render($editor) {
		$editor->vc_include_template( 'editors/popups/panel_templates_editor.tpl.php', array(
			'box' => $this,
                        'editor' => $editor
		) );
	}
