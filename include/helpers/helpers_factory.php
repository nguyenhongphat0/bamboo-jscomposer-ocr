...
//        if(Tools::version_compare(_PS_VERSION_,'1.6.0.9','ge')){            
//            return JsComposer::getInstance();            
//        }else{            
//            return Module::getInstanceByName('jscomposer');
//        }
...
function vc_get_cms_lang_id(){
    return Tools::getValue('id_lang') ? (int)Tools::getValue('id_lang') : 1;
}
...
function vc_get_image_sizes_string(){
