...
$data['image_path'] = $vc_manager->vc_asset_url( 'vc/templates/landing_page.png' );
...
$data['image_path'] = $vc_manager->vc_asset_url( 'vc/templates/call_to_action_page.png' );
$data['content']    = <<<CONTENT
...
$data['image_path'] = $vc_manager->vc_asset_url( 'vc/templates/feature_list.png' );
$data['content']    = <<<CONTENT
...
$data['image_path'] = $vc_manager->vc_asset_url( 'vc/templates/description_page.png' );
$data['content']    = <<<CONTENT
...
$data['image_path'] = $vc_manager->vc_asset_url( 'vc/templates/service_list.png' );
$data['content']    = <<<CONTENT
...
$data['image_path'] = $vc_manager->vc_asset_url( 'vc/templates/product_page.png' );
$data['content']    = <<<CONTENT
