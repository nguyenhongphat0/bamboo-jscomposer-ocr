...
// $mask_markup .= '<div class="blog_mask">
// <div class="mask_content">
// <a itemprop="url" title="" href="'.$p_img_large.'" class="post_lightbox"><i class="icon-resize-full"></i></a>
// <a itemprop="url" title="" href="'.$p_link.'" class="imageFeaturedLink"><i class="icon-link"></i></a>
// </div>
// </div>';
// var_dump('I am link');
...
while ( $my_query->have_posts() ) {
	...
	// $content = ( $grid_content == 'teaser' ) ?  get_the_excerpt()) : get_the_content(); //TODO: get_the_content() rewrite more WP native way.
